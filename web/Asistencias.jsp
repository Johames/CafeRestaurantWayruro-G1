...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <form class="navbar-form navbar-right">
                        <div class="col-lg-pull-0">
                            <input name="filt" onkeyup="filter(this, 'tlc', '1')" type="text"class="form-control" placeholder="Buscar" autofocus>
                        </div>
                    </form>
                    <div id="navbar" class="navbar-collapse collapse">
                        <form class="navbar-form navbar-right">
            ...
            <h1 class="sub-header">Lista de Asistencias Completa</h1>
            <div class="table-responsive">
                <table id="tlc" class="table table-striped well">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Pensionista</th>
